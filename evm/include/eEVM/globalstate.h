...
namespace eevm
{
  ...
  struct GlobalState
  {
    ...
    virtual std::map<Address, std::pair<SimpleAccount, SimpleStorage>> get_all_accounts() = 0;
    virtual void set_block(Block b) = 0;
    virtual void set_accounts(std::map<Address, std::pair<SimpleAccount, SimpleStorage>> acc) = 0;
  };
} // namespace eevm
